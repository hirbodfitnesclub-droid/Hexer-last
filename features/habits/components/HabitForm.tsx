  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 text-right font-sans" dir="rtl" id="habit-form">
      ...
      <div className="pt-4 flex gap-3 shrink-0">
        <button 
          type="submit"
          className="flex-1 bg-[var(--color-primary)] hover:opacity-90 text-[var(--text-on-primary)] py-3 rounded-xl font-bold transition-all text-sm cursor-pointer disabled:bg-[var(--border-subtle)] disabled:text-[var(--text-muted)] disabled:cursor-not-allowed"
          disabled={!name.trim()}
        >
